...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="Hakkımızda"
        title="Mühendisliği bir ürün disiplini olarak görüyoruz."
        description="Gunerdev; startup'lar ve büyüyen işletmeler için yüksek performanslı web uygulamaları geliştiren kurumsal bir yazılım ekibidir. Her projeyi uzun vadeli bir ortaklık olarak ele alıyor; teknik kararlarımızı işinizin uzun vadeli hedeflerine göre şekillendiriyoruz."

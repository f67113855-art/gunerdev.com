...
export const footerNavigation = {
  ...
  solutions: {
    ...
    links: [
      ...
      { label: 'Kafe QR Menü', href: '/kayseri-kafe-qr-menu' },
      { label: 'Emlak Web Sitesi', href: '/kayseri-emlak-web-sitesi' },
      { label: 'Otomotiv Galeri', href: '/kayseri-otomotiv-galeri-web-sitesi' },
      ...
      { label: 'Özel Yazılım', href: '/kayseri-ozel-yazilim' },
      { label: 'Kayseri SEO Hizmeti', href: '/kayseri-seo-hizmeti' },
      { label: 'Yazılım Fiyatları', href: '/kayseri-web-yazilim-fiyatlari' },
    ],
  },
  regions: {
